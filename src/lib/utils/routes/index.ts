...
export const routes = {
  ...
  api: {
    ...
    getorderdetails:(id: string) => `orders/${id}`,
    patchOrderResource:(id: string) => `orders/${id}`,
    getOrderResources:(id: string) => `orders/${id}/admin-detail`,
    postOrderFinalize:(id: string) => `orders/${id}/finalize`,
    postOrderCancel:(id: string) => `orders/${id}/mark-as-cancelled`,
    postOrderReject:(id: string) => `orders/${id}/mark-as-rejected`,
    postOrderItems:(id: string) => `order-items`,
    postOpenItem:(id: string) => `order-items/open-item`,
    putOrderItem:(id: string) => `order-items/${id}`,
    deleteOrderItem:(id: string) => `order-items/${id}`,
    getOrderItemResources:(id: string) => `orders/${id}/order-items`,
